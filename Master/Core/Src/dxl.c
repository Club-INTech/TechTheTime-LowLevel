...
#if INTECH_TARGET == 1
	uint8_t Torque_On_All[] = {0xFF, 0xFF, 0xFD, 0x00, 0xFE, 0x27, 0x00, 0x83, 0x40, 0x00, 0x01, 0x00, 0x02, 0x01, 0x03, 0x01, 0x04, 0x01,
			0x05, 0x01, 0x06, 0x01, 0x07, 0X01, 0x08, 0X01, 0X09, 0x01, 0x0A, 0x01, 0x0B, 0x01, 0x0C, 0x01, 0x0D, 0x01, 0x0E, 0x01,
			0x0F, 0x01, 0x10, 0x01, 0x11, 0x01, 0x00, 0x00};
...
void DXL_Position_Angle(uint8_t id, uint32_t goal_angle){
...
void DXL_Sync_Position(uint8_t *tab, uint8_t size_tab) {
	...
	uint8_t Packet_Head[12] = {0xFF, 0xFF, 0xFD, 0x00, 0xFE, len_packet_1, len_packet_2, 0x83, 0x74, 0x00, 0x02, 0x00};
