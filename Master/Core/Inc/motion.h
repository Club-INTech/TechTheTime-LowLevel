...
typedef enum {
	MOTION_CHANNEL_FORWARD_LEFT = TIM_CHANNEL_2,
	MOTION_CHANNEL_FORWARD_RIGHT = TIM_CHANNEL_4,
	MOTION_CHANNEL_BACKWARD_LEFT = TIM_CHANNEL_1,
	MOTION_CHANNEL_BACKWARD_RIGHT = TIM_CHANNEL_3
} Motion_Channel;
